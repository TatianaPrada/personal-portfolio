  ...
  return (
    <div className="a">
      ...
      <div className="a-right">
        ...
        <p className="a-sub">
          {" "}
          I'm a full-stack web developer located in Porto, focused on both
        ...
        <p className="a-desc">
          ...
          <br></br>
          <span className="a-desc2">
            Throughout my experience as languages teacher and customer service
            representative, I developed communicative, problem-solving and
            organizing skills, that help me in my daily coding times.{" "}
          </span>
        </p>
...
<div> 
        <div className="a-award">
          <a
            href="https://www.credential.net/b1223a61-8bdf-4b7e-b50f-3cdd2fdd01eb#gs.m6tad9"
            target="blank"
          >
